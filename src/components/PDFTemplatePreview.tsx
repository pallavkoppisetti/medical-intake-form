...
const PDFTemplatePreview: React.FC<PDFTemplatePreviewProps> = ({
    ...
    return (
      ...
      {Array.isArray(history?.pastSurgicalHistory) && history.pastSurgicalHistory.length > 0 && (
            ...
            <p className="c0 c1"><span className="c2"></span></p>
            <p className="c0"><span className="c2">Buttoning:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LEFT {physicalExam?.fineGrossManipulativeSkills?.buttoning?.left ?? '[Not assessed]'}/5 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RIGHT {physicalExam?.fineGrossManipulativeSkills?.buttoning?.right ?? '[Not assessed]'}/5 </span></p>
            <p className="c0"><span className="c2">Zipping:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LEFT {physicalExam?.fineGrossManipulativeSkills?.zipping?.left ?? '[Not assessed]'}/5 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RIGHT {physicalExam?.fineGrossManipulativeSkills?.zipping?.right ?? '[Not assessed]'}/5 </span></p>
            <p className="c0"><span className="c2">Picking up a coin:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LEFT {physicalExam?.fineGrossManipulativeSkills?.pickingUpCoin?.left ?? '[Not assessed]'}/5 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RIGHT {physicalExam?.fineGrossManipulativeSkills?.pickingUpCoin?.right ?? '[Not assessed]'}/5 </span></p>
            <p className="c0"><span className="c2">Tying shoelaces:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LEFT {physicalExam?.fineGrossManipulativeSkills?.tyingShoelaces?.left ?? '[Not assessed]'}/5 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RIGHT {physicalExam?.fineGrossManipulativeSkills?.tyingShoelaces?.right ?? '[Not assessed]'}/5</span></p>
            <p className="c0 c1"><span className="c2"></span></p>
            <p className="c0 c1"><span className="c2"></span></p>
            ...
            <p className="c0"><span className="c2">Triceps&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{physicalExam?.reflexes?.triceps?.right ?? '[Not assessed]'}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{physicalExam?.reflexes?.triceps?.left ?? '[Not assessed]'}</span></p>
